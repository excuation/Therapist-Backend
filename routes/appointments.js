...
router.post('/book', authMiddleware, async (req, res) => {
    try {
        ...
        const newTicket = new Ticket({
            service: "Mental Counseling", // Assuming the service is passed or hardcoded
            date: appointmentTime, // Use the same appointmentTime as the date
            time: appointmentTime, // Include the time for the appointment
            therapistName: therapist.name, // Therapist's name
            userName, // User's name (from auth)
            location, // Location from the request body
            disease // Disease from the request body
        });
